...
public final class DefaultMimeMapper implements IMimeMapper {
    ...
    public String getMimeType(String fileName) {
        if (fileName == null || fileName.isBlank()) {
            throw new IllegalArgumentException("File name must not be null, empty, or contain only whitespace.");
        }

        String extension = getFileExtension(fileName);
        if (extension.isEmpty()) {
            throw new IllegalArgumentException("File extension could not be determined from '" + fileName + "'.");
        }
        ...
        synchronized (lock) {
            ...
            throw new IllegalArgumentException("MIME type could not be determined for '" + fileName + "'. Provide a MIME type explicitly or enable fallback.");
        }
    }

    public boolean isValidMimeType(String mimeType) {
        if (mimeType == null || mimeType.isBlank()) {
            throw new IllegalArgumentException("MIME type must not be null, empty, or contain only whitespace.");
        }
    ...
    public boolean addOrUpdateMimeType(String extension, String mimeType) {
        if (extension == null || extension.isBlank()) {
            throw new IllegalArgumentException("Extension must not be null, empty, or contain only whitespace.");
        }
        if (mimeType == null || mimeType.isBlank()) {
            throw new IllegalArgumentException("MIME type must not be null, empty, or contain only whitespace.");
        }
