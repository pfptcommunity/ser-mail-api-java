...
public final class Content {
  ...
  /**
   * Enum representing the type of email content. Supports plain text (TEXT) and HTML (HTML) with
    ...
    public static ContentType fromString(String str) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "Invalid content type value: '" + str + "'. Expected 'TEXT' or 'HTML'.");
      }
    }
  ...
  /**
   * JSON-B adapter for serializing and deserializing ContentType enum. Converts between enum values
   * and their MIME type strings.
   */
