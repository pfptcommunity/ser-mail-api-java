...
/**
 * A legacy example demonstrating how to send an email using the Proofpoint SER API.
 * This class constructs a Message object using the traditional constructor and add methods,
 * showcasing basic email functionality including content, attachments, and recipients.
 */
public class SimpleExample {

  /**
   * Loads configuration from a JSON file into a Map.
   * Reads client credentials from a file for use in initializing the Client.
   *
  ...
  /**
   * Main method demonstrating email construction and sending via the Proofpoint SER API.
   * Uses legacy constructor-based Message creation with incremental additions.
   *
  ...
  public static void main(String[] args) {
    ...
    message.addAttachment(Attachment.builder().fromFile("C:/temp/file.csv").build()); // File from disk
    message.addAttachment(
