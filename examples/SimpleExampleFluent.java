...
/**
 * An example demonstrating email sending using the Proofpoint SER API with a fluent builder.
 * This class constructs a Message object using the modern builder pattern, showcasing a concise
 * and readable approach to email creation with build-time validation.
 */
public class SimpleExampleFluent {

    /**
     * Loads configuration from a JSON file into a Map.
     * Reads client credentials (e.g., client_id, client_secret) from a file for Client initialization.
     *
     ...
     * Utilizes the fluent builder pattern for Message creation, ensuring required fields are set.
     *
